    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_earnings', models.DecimalField(max_digits=20, decimal_places=15, default=0.0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_id', models.CharField(default=False, max_length=200)),
                ('btc_confirmations', models.IntegerField(default=0)),
                ('btc_address', models.CharField(max_length=400)),
                ('btc_amount', models.DecimalField(max_digits=20, decimal_places=15, default=0.0)),
